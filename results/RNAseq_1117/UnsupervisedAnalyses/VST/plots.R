...
NUMBER_PCS = 6
data <- read.csv("/Users/charlesmurphy/Desktop/Research/0617_yuxiang/results/RNAseq_1117/HTSeqCount/HTSeq.gene-symbols.vst.csv",row.names=1,check.names=F)
...
samples$group <- paste(samples$cell_line,samples$sensitivity,samples$media_conditions,sep="-")
