...
NUMBER_PCS = 6
data <- read.csv("/Users/charlesmurphy/Desktop/Research/0617_yuxiang/results/RNAseq_1217/Cufflinks/genes-fpkm.csv",row.names=1,check.names=F)
data[data<0.1] <- 0
data <- log2(data+0.1)
...
result <- pvclust(data, method.dist=spearman, method.hclust="average", nboot=10000,parallel=T)
